  ...
  function(declare, lang, array, html, query, Color, on, Evented, _WidgetBase, _TemplatedMixin,
    ...
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
      ...
      setConfig: function(config){
        ...
        this.reset();
        this.cbxAxisX.checked = config.horizontalAxis === false ? false : true;
        this.cbxAxisY.checked = config.verticalAxis === false ? false : true;
        this.cbxPieLabel.checked = config.label === false ? false : true;
      ...
      getConfig: function(){
        ...
        if(this.type === 'pie'){
          ...
          config.label = this.cbxPieLabel.checked;
        }
        else{
          config.horizontalAxis = this.cbxAxisX.checked;
          config.verticalAxis = this.cbxAxisY.checked;
          if(this.singleColor){
