...
define([
  ...
  function (declare, lang, array, html, query, esriBundle, on, _WidgetsInTemplateMixin, BaseWidget, MapManager, LayerInfos, Editor, Popup, TemplatePicker, Button, editUtils, FilterEditor) {
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      name: 'FilterEdit',
      baseClass: 'jimu-widget-filter-edit',
      editor: null,
      _defaultStartStr: "",
      _defaultAddPointStr: "",
      resetInfoWindow: {},
      ...
      startup: function () {
        ...
        this.editPopup = new Popup(null, html.create("div", {
          "class": "jimu-widget-filter-edit-infoWindow"
        }, null, this.map.root));
      },
      ...
      _enableMapClickHandler: function () {
        if (this.editor && this.editor._mapClickHandler) {
          this._editorMapClickHandlers.push(this.editor._mapClickHandler);
          if (typeof this.editor._enableMapClickHandler === 'function') {
      ...
      _disableMapClickHandler: function () {
        if (this.editor && this._editorMapClickHandlers) {
          if (typeof this.editor._disableMapClickHandler === 'function') {
      ...
      _convertConfiguredLayerInfos: function (layerInfos) {
      ...
      _getLayerInfosParam: function () {
        ...
        if (!this._configEditor.layerInfos) {
          ...
          layerInfos = this._convertConfiguredLayerInfos(this._configEditor.layerInfos);
        } else {
      ...
      _update: function () {
        ...
        if (this.config.editor.useFilterEdit) {
